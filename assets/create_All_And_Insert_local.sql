...
COPY bai.Programmateur FROM :'programmateur_path' WITH DELIMITER ',' CSV HEADER;
COPY bai.Ville FROM :'ville_path' DELIMITER ',' CSV HEADER;
COPY bai.Cinema FROM :'cinema_path' DELIMITER ',' CSV HEADER;
COPY bai.Festival FROM :'festival_path' DELIMITER ',' CSV HEADER;
